...
//	NSLog(shopId);
	...
	NSString	*strVisiteDate=   [NSString stringWithFormat:@"%d/%d/%d",(int)selectDate.year,selectDate.month,selectDate.day];
	...
	NSString *timestamp = [NSString stringWithFormat:@"%d年%d月%d日",(int)selectDate.year,selectDate.month,selectDate.day];
