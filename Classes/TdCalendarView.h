...
- (void)drawPeopleCountWords:(CGPoint)pointGroup  personCount:(CGPoint)peopleCount team:(DDXMLNode *)team;
...
- (NSArray *)getCalendarMonthMemoData:(NSString *)strYearMonthDate;
